...
arr = [21, 63, 84];
function Plus42(value, index, array) {
	var NewValue = value + 42;
...
function arrayCleanUp(arrayToCleanUp) {
	var cleanedUp = arrayToCleanUp.filter(function (element){
